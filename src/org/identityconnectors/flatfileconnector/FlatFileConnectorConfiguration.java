...
public class FlatFileConnectorConfiguration extends AbstractConfiguration {
	...
	@ConfigurationProperty(order = 1, required = true, helpMessageKey = "configuration.lookupReconFile.help", displayMessageKey = "configuration.lookupReconFile.display")
	...
	@ConfigurationProperty(order = 1, required = false, helpMessageKey = "configuration.customscriptfileforrecon.help", displayMessageKey = "configuration.customscriptfileforrecon.display")
	...
	@ConfigurationProperty(order = 1, required = true, helpMessageKey = "configuration.targetfile.help", displayMessageKey = "configuration.targetfile.display")
