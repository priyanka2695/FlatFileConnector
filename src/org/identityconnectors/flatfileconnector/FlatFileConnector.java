...
public class FlatFileConnector implements PoolableConnector, CreateOp, UpdateOp, DeleteOp, SearchOp<Map<String, String>>, SchemaOp,TestOp
{
	...
	private void createSshConnection(){
		System.out.println("FlatFileConnector.createSshConnection()");
	...
	public Uid create(ObjectClass oclass, Set<Attribute> attrs,
		...
		if(customScriptFile != null){
			...
			ProcessBuilder pb = new
					ProcessBuilder(customScriptFile.getAbsolutePath(),id,firstName,lastName,email);
...
//	}
	...
	private Map<String, HashMap<String, List<String>>> getIncrementalSearchResult(BufferedReader reader,
			File targetFile, String uniqueAttribute, Map<String, String> queryMap) {
	...
	getSearchResult(BufferedReader reader,File targetFile,String
		...
		try {
			...
			throw new RuntimeException("Exception while reading the targetfile "+e.getMessage());
		}
	...
	public void test() {
		System.out.println("FlatFileConnector.test()");
		createSshConnection();
	}

	@Override
	public FilterTranslator<Map<String, String>> createFilterTranslator(ObjectClass arg0, OperationOptions arg1) {
